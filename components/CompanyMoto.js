      ...
      <div className="container mx-auto flex flex-row flex-wrap items-center justify-center gap-9">
        <div className="flex flex-col items-center justify-center p-5">
          <div className="rounded-full bg-white p-5">
            <Headphones className="inline-block h-5 w-6 stroke-green-500" />
          </div>
        ...
        <div className="flex flex-col items-center justify-center p-5">
          <div className="rounded-full bg-white p-5">
            <CreditCard className="inline-block h-5 w-6 stroke-green-500" />
          </div>
        ...
        <div className="flex flex-col items-center justify-center p-5">
          <div className="rounded-full bg-white p-5">
            <CornerUpLeft className="inline-block h-5 w-6 stroke-green-500" />
          </div>
        ...
        <div className="flex flex-col items-center justify-center p-5">
          <div className="rounded-full bg-white p-5">
            <Truck className="inline-block h-5 w-6 stroke-green-500" />
          </div>
