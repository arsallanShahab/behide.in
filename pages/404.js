      ...
      <div className="relative flex w-full items-center justify-center ">
        ...
        <div className="relative z-[1]">
          ...
          <div className="mt-8 text-center">
            <Link
              href="/"
              className="inline-block rounded-xl border bg-gray-50 px-6 py-4 font-sora text-sm font-medium text-black duration-150 hover:bg-gray-100 active:scale-95 active:bg-gray-200"
            >
