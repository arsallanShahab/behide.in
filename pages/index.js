      ...
      <div className="slideshow">
        ...
        >
          {homeBannerItems.map((item, index) => {
            return (
              <SwiperSlide>
                <div className="relative bg-brandGrey flex flex-col justify-center items-center sm:flex-row pt-10 pb-44 px-6">
                  <div className="flex flex-col items-center sm:items-start text-center basis-1/2 px-4 sm:px-8">
                    <h3 className="py-3 font-rubik uppercase font-semibold word-spacing-trending align-middle text-[#afafaf]">
                      ...
                      <svg
                        ...
                        className="feather feather-zap inline-block -ml-2 -mt-1"
                      >
                    ...
                    <p className="mt-10 text-brandMediumGrey pl-5 border-l-0 sm:border-l-4 font-poppins word-spacing font-semibold text-center sm:text-left max-w-md text-sm leading-relaxed">
                      {item.homeBannerDescription}
                    </p>
                    <Link
                      className="mt-10 relative inline-block capitalize font-poppins font-semibold  text-base py-5 px-16  bg-brandTeal text-white"
                      href={`/products/${item.homeBannerLink.sys.id}`}
                    >
                      <span className="mr-3">Check out</span>
                      <div className="absolute -right-3 -top-6 rounded-full pt-4 pb-2 px-4 bg-brandYellow">
                        <svg
                          width="30"
                          height="30"
                          viewBox="0 0 67 67"
                  ...
                  <div className="flex justify-center items-center basis-1/2 w-full">
