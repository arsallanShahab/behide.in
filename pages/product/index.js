...
const index = () => {
  //   console.log(data);
  //   const { name, id, category, product } = data;
  return (
    <div>product</div>
    ...
    //           <Link
    //             href={`/product?name=${product.productName}&id=${product.sys.id}&category=${product.productType}`}
    //             aria-current="page"
...
//   return {
//     props: {
//       data: { name, category, id, product: data },
//     },
//   };
// };
...
//   //   const ids = entries.map((item, index) => item._id);
//   const paths = entries.map((item) => ({
//     params: {
//       id: `?name=${item.fields.productName}&category=${item.fields.productCategory}&id=${item.sys.id}`,
//     },
//   }));
//   return {
//     paths,
